...
class Cfgs(PATH):
    def __init__(self):
        ...
        if self.DATASET != "VQA2":
            ...
            self.RESULT_PATH = './results/result_test/' + self.DATASET + '/'
            self.PRED_PATH = './results/pred/' + self.DATASET + '/'
            self.CACHE_PATH = './results/cache/' + self.DATASET + '/'
            self.LOG_PATH = './results/log/' + self.DATASET + '/'
            self.CKPTS_PATH = './ckpts/' + self.DATASET + '/'
            ...
            if os.path.exists(self.CKPTS_PATH):
        ...
        # self.if_bi_attn = False
        # self.if_rec_weight = False
        # self.if_rec_img_f = False
        # self.if_rec_que_f = False
    ...
    #     ADD
        self.recon_rate = 1
        self.model_type = 'recon_e'
        self.num_channel = 1
        # self.model_type = 'base'
        # self.model_type = 'none'
        # self.PRE_E = 5
        self.PRE_E = 5
        self.entropy_tho = 0.0

        self.GA_layer =6

        self.AGCAN_MODE = 'base'

        # Model hidden size
        # (512 as default, bigger will be a sharp increase of gpu memory usage)
        self.HIDDEN_SIZE = 512

        # self.model_type = 'multi_channel'
        # self.num_channel = 8
